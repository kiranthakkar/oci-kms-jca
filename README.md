...
## Installation
You can use the library in your Java application or use the jar file with Java utilities like keytool and jarsigner. 

You can find more details instructions from

keytool blog link (TBD)
jarsigner blog ling (TBD)
